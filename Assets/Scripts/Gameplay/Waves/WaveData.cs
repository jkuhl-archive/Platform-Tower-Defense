...
namespace Gameplay.Waves
{
    ...
    public class WaveData
    {
        ...
        {
            if (spawnIndex < waveSpawns.Count)
            {
                return true;
            }
        ...
        public WaveSpawnObject GetNextSpawn()
        {
            ...
            {
                WaveSpawnObject nextSpawn = waveSpawns[spawnIndex];
                spawnIndex++;
        ...
        public void GiveReward()
        {
            ...
            {
                rewardGiven = true;
                GameUtils.GetRootGameObjectByName("GameLogic").GetComponent<PlayerLogic>()
                    .UpdatePlayerMoney(waveReward);
            }
        }
    }
}